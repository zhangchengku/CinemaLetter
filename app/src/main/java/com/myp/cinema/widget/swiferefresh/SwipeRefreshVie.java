package com.myp.cinema.widget.swiferefresh;
...
public class SwipeRefreshVie extends SwipeRefreshLayout {
    ...
    private boolean isloadi;

    public SwipeRefreshVie(Context context, AttributeSet attrs) {
        super(context, attrs);
        // 填充底部加载布局
...
//            System.out.println("不是正在加载状态");
    ...
    public void setend(boolean loadi) {
        // 修改当前的状态
        isloadi = loadi;
        if(isloadi){
